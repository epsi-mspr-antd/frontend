...
export const deleteUserPlantById = async (idPlant: number, accessToken: string) => {
...
export const editPlant = async (accessToken: string,  data: CreatePlant, idPlant: number) => {
