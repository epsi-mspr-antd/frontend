...
export const SettingsSharing = () => {
    return (
        <div className="flex flex-col justify-around p-4">
            ...
            <span className='text-start'>En acceptant le partage, vous acceptez que les autres utilisateurs voient vos informations</span>

            <section className="mt-4 flex flex-col gap-4 text-start pl-2 text-sm">
